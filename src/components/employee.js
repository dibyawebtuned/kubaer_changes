                        ...
                        {team.map((person, i) => (
                            ...
                            >
                                ...
                                <div className="p-4! flex flex-col gap-2! sm:gap-3!">
                                    <div className="text-center font-bold text-gray-900 text-[16px]! sm:text-[16px]! md:text-[18px]! lg:text-[20px]! text-transparent bg-clip-text bg-linear-to-r from-[#86489B] to-[#F171AC] leading-4.5">
                                        {person.name}
                                    </div>
