...
export default function AboutComponent() {
    ...
    return (
        <div className="bg-white">
            <div className="container mx-auto py-16 flex flex-col gap-8 sm:gap-12">
                <div className="flex flex-col md:flex-row gap-[10px] md:gap-[60px] sm:items-center">
                    <div className={`${archivo.className} flex-1 text-[41px] sm:text-[40px] md:text-[54px] font-[500] leading-snug text-left text-transparent bg-clip-text bg-gradient-to-r from-[#86489B] to-[#F171AC]`}
                        data-aos="fade-right"
                ...
                {/* Images */}
                <div className="relative w-full h-64 sm:h-96 md:h-[500px] overflow-hidden"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="800"
                    data-aos-once="true">
            ...
            <div className="container py-16">
                ...
                <div className="flex flex-col gap-[15px]"
                    ...
                    data-aos-once="true">
                    <div>
                        <span className="text-[32px] font-[600] text-transparent bg-clip-text bg-gradient-to-r from-[#86489B] to-[#F171AC]">What Drives Us Forward</span>
                    </div>
                    <div className="w-[50%]">
                ...
                <div className="flex gap-5">
                    {/* Image */}
                    <div className="relative flex-1 h-[300px] md:h-[400px]">
                        <Image
                            src={about_image}
                            alt="About Us Illustration"
                            fill
            ...
            {/* Core Values */}
            <div className="container mx-auto px-4 py-16 text-white bg-[linear-gradient(to_right,_#86489B,_#F171AC)] rounded-[20px] mb-[50px] flex flex-col gap-[50px]">
                {/* Core Values Title */}
                <div className="flex flex-col gap-[15px] justify-center">
                    <div className="text-[33px] text-center font-semibold"
                        data-aos="fade-up"
                        data-aos-duration="1000"
                        data-aos-delay="100"
                        data-aos-once="true">
                    ...
                    <div className="flex justify-center">
                        <div className={`text-[#d8d8d8] w-[60%] text-center ${roboto.className} leading-[25px] font-[400] tracking-[-1%]`}
                            data-aos="fade-up"
                            data-aos-duration="1000"
                            data-aos-delay="300"
                            data-aos-once="true">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center">
                    ...
                    <div className="flex flex-col justify-between gap-[40px]">
                        ...
                        <div className="flex justify-center items-center"
                            ...
                            data-aos-delay="100"
                            data-aos-once="true">
                            <div className="flex flex-col gap-[7px] w-[350px] bg-white/25 backdrop-blur-lg rounded-2xl p-6 text-center text-white transition-transform transform hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]">
                                <div className="text-xl font-semibold text-start">Communication</div>
                                <div>
                                    <p className="text-white text-start m-0">We believe in clear, open, and honest communication to build lasting relationships with our clients and team as an opportunity to lead.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center items-center"
                            ...
                            data-aos-once="true">
                            <div className="flex flex-col gap-[7px] w-[350px] bg-white/25 backdrop-blur-lg rounded-2xl p-6 text-center text-white transition-transform transform hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]">
                                <div className="text-xl font-semibold text-start">Growth</div>
                                <div>
                                    <p className="text-white text-start m-0">We’re committed to continuous improvement—helping our clients grow financially while growing as individuals and</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col justify-between gap-[40px]">
                        ...
                        <div className="flex justify-center items-center"
                            ...
                            data-aos-once="true">
                            <div className="flex flex-col gap-[7px] w-[350px] bg-white/25 backdrop-blur-lg rounded-2xl p-6 text-center text-white transition-transform transform hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]">
                                <div className="text-xl font-semibold text-start">Teamwork</div>
                                <div>
                                    <p className="text-white text-start m-0">Collaboration is at the core of our success. We work together across all levels to achieve shared goals and deliver exceptional results.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-center items-center"
                            ...
                            data-aos-once="true">
                            <div className="flex flex-col gap-[7px] w-[350px] bg-white/25 backdrop-blur-lg rounded-2xl p-6 text-center text-white transition-transform transform hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]">
                                <div className="text-xl font-semibold text-start">Ownership</div>
                                <div>
                                    <p className="text-white text-start m-0">We take responsibility for our actions, follow through on commitments, and treat every challenge as an opportunity to lead</p>
                                </div>
                            </div>
                        </div>
                    </div>
