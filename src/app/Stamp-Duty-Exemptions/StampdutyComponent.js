        ...
        <div className="container mx-auto relative">
          ...
          <div className={`flex flex-wrap gap-4 mb-16 scroll-reveal ${roboto.className}`} style={{ animationDelay: "0.3s" }}>
            <div className="flex gap-3 lg:p-0">
              <div className="">
                <a href="#who-qualifies" className="extra-btn btn-default">
                  Check Eligibility →
                </a>
              </div>

              <div className="">
                <a href="#by-state" className="btn-default">
                  By State
                </a>
              </div>
            </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            {[
              ...
              <div key={c.type} className="bg-white rounded-2xl p-8 card-hover" style={{ border: `1.5px solid ${c.color}33` }}>
                ...
                <p className={`${archivo.className} text-sm! font-normal! tracking-normal!`} style={{ color: "#6B6B6B", lineHeight: 1.7 }}>{c.desc}</p>
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <div className="bg-white rounded-2xl p-6 card-hover" style={{ border: "1px solid rgba(134,72,155,0.12)" }}>
              <h3 className={`${archivo.className} text-lg! font-semibold! mb-4!`} style={{ color: "#86489B" }}>What Stamp Duty Covers</h3>
              <ul className="space-y-2">
                {[
                  ...
                  <li key={item} className={`flex! items-start! gap-2! text-sm! font-normal! ${archivo.className}`} style={{ color: "#6B6B6B" }}>
            ...
            <div className="bg-white rounded-2xl p-6 card-hover" style={{ border: "1px solid rgba(241,113,172,0.2)" }}>
              <h3 className={`${archivo.className} text-lg! font-semibold! mb-4!`} style={{ color: "#F171AC" }}>Not Included in Stamp Duty</h3>
              <ul className="space-y-2">
                {[
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <div className="bg-white rounded-2xl p-8 card-hover" style={{ border: "1.5px solid rgba(134,72,155,0.2)" }}>
              <h3 className={`${archivo.className} text-xl font-medium! mb-6!`} style={{ color: "#86489B" }}>Common Requirements</h3>
            ...
            <div className="space-y-5">
              ...
              <div className="info-box rounded-2xl p-5">
                <h3 className={`${archivo.className} text-xl font-medium! mb-3!`} style={{ color: "#86489B" }}>Owner-Occupier Residency Rule</h3>
          ...
          <div className="rounded-2xl overflow-hidden bg-white mb-10" style={{ border: "1px solid rgba(134,72,155,0.15)" }}>
            {CHECKLIST.map((item, i) => (
              <div key={i} className="flex items-start gap-4 px-6 py-4" style={{ borderBottom: i < CHECKLIST.length - 1 ? "1px solid rgba(134,72,155,0.07)" : "none", backgroundColor: i % 2 === 0 ? "white" : "rgba(134,72,155,0.02)" }}>
                ...
                <span className={`${archivo.className} font-normal! text-[16px]!`} style={{ color: "#000000", lineHeight: 1.6 }}>{item}</span>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="font-body font-semibold px-6 py-2 rounded-full text-base"
                style={{
