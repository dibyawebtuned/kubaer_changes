      ...
      ══════════════════════════════════════ */}
            <section id="about" className="px-6 md:px-12 py-24" style={{ backgroundColor: "#ffffff" }}>
                <div className="container mx-auto">
                    ...
                    {/* worked example */}
                    <h3 className="font-display text-2xl font-bold mb-6" style={{ color: "#000000" }}>Example: $600,000 New Home</h3>
      ...
      ══════════════════════════════════════ */}
            <section id="eligibility" className="px-6 md:px-12 py-24" style={{ backgroundColor: "#FEF3F8" }}>
                <div className="container mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-10">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="bg-white rounded-2xl p-6 card-hover" style={{ border: "1.5px solid rgba(241,113,172,0.25)" }}>
                                <h3 className="font-display text-xl font-bold mb-4" style={{ color: "#F171AC" }}>Income Thresholds</h3>
                                ...
                                <p className="font-body text-xs mt-3" style={{ color: "#6B6B6B" }}>Thresholds are updated each year on 1 July based on your most recent Notice of Assessment.</p>
                            </div>

                            {/* property types */}
                            <div className="bg-white rounded-2xl p-6 card-hover" style={{ border: "1.5px solid rgba(134,72,155,0.2)" }}>
                                <h3 className="font-display text-xl font-bold mb-4" style={{ color: "#86489B" }}>Eligible Property Types</h3>
                    ...
                    {/* property price caps */}
                    <h3 className="font-display text-2xl font-bold mb-6" style={{ color: "#000000" }}>Property Price Caps by State</h3>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                        {[
                            ...
                            <div key={c.state} className="guarantee-card rounded-2xl p-5 card-hover text-center">
                                <div className="font-display text-2xl font-black highlight-number mb-2">{c.state}</div>
                                <div className="font-body text-xs mb-1" style={{ color: "#6B6B6B" }}>Capital city</div>
                                <div className="font-display font-bold text-base mb-2" style={{ color: "#86489B" }}>{c.city}</div>
                                {c.regional !== "—" && (
                                    <>
                                        <div className="font-body text-xs mb-1" style={{ color: "#6B6B6B" }}>Regional</div>
                                        <div className="font-display font-bold text-sm" style={{ color: "#F171AC" }}>{c.regional}</div>
                                    </>
                                )}
                            </div>
                        ))}
                    ...
                    <div className="rounded-3xl p-8 md:p-10" style={{ background: "linear-gradient(135deg, #86489B, #F171AC)" }}>
                        <div className="grid md:grid-cols-2 gap-8 items-start">
                            <div>
                                <h3 className="font-display text-2xl font-bold text-white mb-3">Single Parent Provisions</h3>
            ...
            <section id="how-it-works" className="px-6 md:px-12 py-24" style={{ backgroundColor: "#ffffff" }}>
                <div className="container mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-5">
                        {[
                            { title: "Pre-approval window", body: "Your Help to Buy place is reserved for 90 days, aligned with your loan pre-approval. A 90-day extension is available if needed (not guaranteed).", icon: "⏱", color: "#F171AC" },
                            { title: "Contract settlement gap", body: "Contracts must allow at least 30 days between signing and settlement. Ensure your lender has all documents at least 29 days prior to settlement.", icon: "📄", color: "#86489B" },
                            { title: "Home insurance", body: "Home insurance is mandatory under Help to Buy and must be arranged before settlement. Factor premiums into your overall affordability calculations.", icon: "🛡️", color: "#6B6B6B" },
                        ].map((c) => (
                ...
                <div className="container mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-10">
                        ...
                        <div className="bg-white rounded-2xl p-8 card-hover" style={{ border: "1px solid rgba(134,72,155,0.12)" }}>
                            <h3 className="font-display text-xl font-bold mb-6" style={{ color: "#86489B" }}>Your Buy-Back Options</h3>
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={r.type} className="rounded-xl p-4" style={{ backgroundColor: "#FDF2F9", border: "1px solid rgba(134,72,155,0.1)" }}>
                                        ...
                                        <div className="font-body text-xs" style={{ color: "#6B6B6B", lineHeight: 1.7 }}>{r.desc}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 card-hover" style={{ border: "1px solid rgba(241,113,172,0.2)" }}>
                            <h3 className="font-display text-xl font-bold mb-6" style={{ color: "#F171AC" }}>Example: Incremental Buy-Back</h3>
                            <div className="space-y-4">
                                <div className="rounded-xl p-4" style={{ backgroundColor: "#FEF3F8", border: "1px solid rgba(241,113,172,0.15)" }}>
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {[{ l: "Home value", v: "$800,000" }, { l: "Gov equity (30%)", v: "$240,000" }].map(x => (
                                            <div key={x.l}>
                                                <div className="font-body text-xs" style={{ color: "#6B6B6B" }}>{x.l}</div>
                                                <div className="font-display font-bold text-base" style={{ color: "#F171AC" }}>{x.v}</div>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                <div className="rounded-xl p-4" style={{ backgroundColor: "#FEF3F8", border: "1px solid rgba(241,113,172,0.15)" }}>
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {[{ l: "New home value", v: "$880,000" }, { l: "5% buy-back", v: "$44,000" }].map(x => (
                                            <div key={x.l}>
                                                <div className="font-body text-xs" style={{ color: "#6B6B6B" }}>{x.l}</div>
                                                <div className="font-display font-bold text-base" style={{ color: "#86489B" }}>{x.v}</div>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                    ...
                    {/* income assessment */}
                    <h3 className="font-display text-2xl font-bold mb-6" style={{ color: "#000000" }}>What Counts as Income</h3>
                    <div className="grid md:grid-cols-2 gap-5">
                        <div className="bg-white rounded-2xl p-6 card-hover" style={{ border: "1px solid rgba(134,72,155,0.12)" }}>
                            <h4 className="font-display font-bold text-base mb-4" style={{ color: "#86489B" }}>Included in assessment</h4>
                            <div className="space-y-2">
                                {INCOME_ITEMS.map((item) => (
                                    <div key={item.label} className="income-row rounded-lg px-3 py-2">
                                        <div className="font-body text-sm font-medium" style={{ color: "#000000" }}>{item.label}</div>
                        ...
                        <div className="bg-white rounded-2xl p-6 card-hover" style={{ border: "1px solid rgba(241,113,172,0.2)" }}>
                            <h4 className="font-display font-bold text-base mb-4" style={{ color: "#F171AC" }}>NOT included in assessment</h4>
                            <div className="space-y-3">
                                {INCOME_EXCLUSIONS.map((item) => (
                                    <div key={item} className="flex items-center gap-3 rounded-xl px-4 py-3" style={{ background: "rgba(241,113,172,0.06)", border: "1px solid rgba(241,113,172,0.15)" }}>
                                        ...
                                        <span className="font-body text-sm" style={{ color: "#000000" }}>{item}</span>
                                    </div>
                                ))}
                            </div>
      ...
      ══════════════════════════════════════ */}
            <section id="construction" className="px-6 md:px-12 py-24" style={{ backgroundColor: "#ffffff" }}>
                <div className="container mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-10">
                        <div className="bg-white rounded-2xl p-8 card-hover" style={{ border: "1.5px solid rgba(134,72,155,0.2)" }}>
                            <h3 className="font-display text-xl font-bold mb-6" style={{ color: "#86489B" }}>Contract Requirements</h3>
                            <ul className="space-y-3">
                                {[
                        ...
                        <div className="space-y-5">
                            {/* timeframes */}
                            <div className="bg-white rounded-2xl p-6 card-hover" style={{ border: "1.5px solid rgba(241,113,172,0.25)" }}>
                                <h3 className="font-display text-xl font-bold mb-4" style={{ color: "#F171AC" }}>Construction Timeframes</h3>
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={r.label} className="flex items-start justify-between gap-3 rounded-xl p-3" style={{ backgroundColor: "#FDF2F9" }}>
                                            <div className="font-body text-xs" style={{ color: "#6B6B6B" }}>{r.label}</div>
                            ...
                            <div className="warning-box rounded-2xl p-5">
                                <h4 className="font-display font-bold text-base mb-2" style={{ color: "#F171AC" }}>Managing Cost Overruns</h4>
                                <p className="font-body text-sm" style={{ color: "#6B6B6B", lineHeight: 1.7 }}>
                            ...
                            {/* contract changes */}
                            <div className="info-box rounded-2xl p-5">
                                <h4 className="font-display font-bold text-base mb-2" style={{ color: "#86489B" }}>Making Contract Changes</h4>
                                <p className="font-body text-sm" style={{ color: "#6B6B6B", lineHeight: 1.7 }}>
                    ...
                    <h3 className="font-display text-2xl font-bold mb-6" style={{ color: "#000000" }}>Help to Buy vs First Home Guarantee</h3>
                    <div className="bg-white rounded-2xl overflow-hidden" style={{ border: "1px solid rgba(134,72,155,0.15)" }}>
                        <div className="grid grid-cols-3 px-6 py-4 font-display font-bold text-sm" style={{ backgroundColor: "#FDF2F9", borderBottom: "1px solid rgba(134,72,155,0.1)", color: "#86489B" }}>
                            ...
                            <span>First Home Guarantee</span>
                        </div>
                        {[
                            ["Minimum deposit", "2%", "5%"],
                            ...
                            <div key={feature} className="grid grid-cols-3 px-6 py-4 font-body text-sm" style={{ borderBottom: i < 6 ? "1px solid rgba(134,72,155,0.07)" : "none", backgroundColor: i % 2 === 0 ? "white" : "rgba(134,72,155,0.02)" }}>
            ...
            <section className="px-6 md:px-12 py-24" style={{ background: "linear-gradient(135deg, #86489B 0%, #F171AC 100%)" }}>
                <div className="container mx-auto text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        <a
                            href="https://www.housingaustralia.gov.au/support-buy/help-buy"
                            target="_blank"
                            rel="noreferrer"
                        ...
                        <a
                            href="https://www.commbank.com.au/home-loans/help-to-buy.html"
                            target="_blank"
                            rel="noreferrer"
                            className="font-body font-semibold px-8 py-4 rounded-full text-lg"
