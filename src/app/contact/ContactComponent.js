        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          <div className="flex-1 flex flex-col gap-6 lg:gap-8">
            ...
            <div
              ...
              data-aos-once="true"
            >
              Talk to us about your home loan needs and we will package up a
              home loan with the features you want and tailor the rate to your
              circumstance.
            </div>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-sm sm:text-[14px]">
                      Plympton Park SA 5038, Australia
                    </span>
                  </div>
                </div>
