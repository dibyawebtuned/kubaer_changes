            ...
            <div className="container mx-auto px-4 py-12">
                ...
                <div className="flex flex-col lg:flex-row gap-3 items-center">
                    ...
                    <div className="flex-1 flex flex-col gap-3">
                        {/* Title */}
                        <div className="text-[36px] md:text-[54px] font-medium leading-snug text-transparent bg-clip-text bg-gradient-to-r from-[#86489B] to-[#F171AC]"
                            data-aos="fade-right"
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div className="flex-1 flex items-center gap-4"
                                    ...
                                    <div>
                                        <div className="text-[18px] font-semibold text-[#4d4d4d]">Email Us</div>
                                        <span>loans@kubaer.com.au</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 flex items-center gap-4"
                                    ...
                                    <div>
                                        <div className="text-[18px] font-semibold text-[#4d4d4d]">Call Us</div>
                                        <span>1300 KUBAER</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div className="flex-1 flex items-center gap-4"
                                    ...
                                    <div>
                                        <div className="text-[18px] font-semibold text-[#4d4d4d]">Address</div>
                                        <span>Plympton Park SA 5038, Australia</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 flex items-center gap-4"
                                    ...
                                    <div>
                                        <div className="text-[18px] font-semibold text-[#4d4d4d]">Website</div>
                                        <span>https://kubaer.com.au/</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <form className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <input
                                    ...
                                    className="flex-1 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#f171ac]"
                                />
                                <input
                                    type="text"
                            ...
                            <textarea
                                ...
                                className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#f171ac]"
                            ></textarea>

                            {/* Submit Button */}
                            <button
                                type="submit"
                                className="mt-2 text-white bg-[#f171ac] px-6 py-2 rounded-lg hover:bg-[#86489b] transition"
                            >
                                Submit Form
                            </button>
                        </form>
