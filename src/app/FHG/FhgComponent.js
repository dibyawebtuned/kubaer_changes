      ...
      `}</style>
                ...
                <div className="container mx-auto">
                    ...
                    <div className="rounded-3xl p-8 md:p-12" style={{ background: "linear-gradient(135deg, #86489B, #F171AC)" }}>
                        <div className="grid md:grid-cols-2 gap-8 items-center">
                            <div>
                                <h3 className="font-display text-3xl font-bold text-white mb-4">Built for single parents.</h3>
            ...
            <section id="eligibility" className="px-6 md:px-12 py-24" style={{ backgroundColor: "#FEF3F8" }}>
                <div className="container mx-auto">
                    ...
                    <div className="bg-white rounded-2xl p-8 mb-6 card-hover" style={{ border: "1.5px solid rgba(134,72,155,0.15)" }}>
                        <h3 className="font-display text-xl font-bold mb-5" style={{ color: "#86489B" }}>What is a Dependent Child?</h3>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2">
                                    {["A child under 16 who lives with you and is in your care", "A person aged 16–22 who is wholly or substantially dependent on you", "A person 16+ receiving a disability support pension who lives with you"].map(x => (
                                        <li key={x} className="flex items-start gap-2"><span style={{ color: "#86489B" }}>✓</span>{x}</li>
                                    ))}
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="space-y-2">
                                    {["Not in full-time education and earns above the permitted income threshold", "Married or in a partner relationship with the applicant", "Receives social security benefits making them financially independent"].map(x => (
                                        <li key={x} className="flex items-start gap-2"><span style={{ color: "#F171AC" }}>✕</span>{x}</li>
                                    ))}
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="rounded-2xl p-6" style={{ background: "rgba(0,0,0,0.03)", border: "1px solid rgba(0,0,0,0.08)" }}>
                        <h4 className="font-display font-bold text-lg mb-4" style={{ color: "#000000" }}>⚠ Not Eligible Under FHG</h4>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
                        {ELIGIBLE_PROPERTIES.map((p) => (
                            <div key={p.type} className="bg-white rounded-2xl p-6 card-hover" style={{ border: "1px solid rgba(134,72,155,0.12)" }}>
                                ...
                                <h4 className="font-display font-bold text-lg mb-2" style={{ color: "#86489B" }}>{p.type}</h4>
                        ...
                        <div className="rounded-2xl p-6" style={{ background: "rgba(241,113,172,0.07)", border: "1px dashed rgba(241,113,172,0.4)" }}>
                            ...
                            <h4 className="font-display font-bold text-lg mb-2" style={{ color: "#F171AC" }}>Not Eligible</h4>
                            <p className="font-body text-sm" style={{ color: "#6B6B6B", lineHeight: 1.6 }}>Investment properties, holiday homes, commercial properties, and owner-builder arrangements are not eligible under the scheme.</p>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="mt-10 grid md:grid-cols-3 gap-5">
                        {[
                            ...
                            <div key={t.label} className="guarantee-card rounded-2xl p-6">
                                <div className="font-display text-2xl font-black highlight-number mb-1">{t.time}</div>
                                <div className="font-display font-bold text-base mb-2" style={{ color: "#000000" }}>{t.label}</div>
                                <p className="font-body text-xs" style={{ color: "#6B6B6B", lineHeight: 1.6 }}>{t.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="px-6 md:px-12 py-24" style={{ backgroundColor: "#ffffff" }}>
                <div className="container mx-auto">
                    ...
                    <div className="mb-8">
                        <h4 className="font-display font-bold text-lg mb-4" style={{ color: "#F171AC" }}>Regional Banks, Credit Unions & Customer-Owned Lenders</h4>
                        <div className="flex flex-wrap gap-3">
